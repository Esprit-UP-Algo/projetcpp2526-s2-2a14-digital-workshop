                   ...
                   int montant_total_commande)
{
    ...
    {
        QSqlQuery query;
        query.prepare("INSERT INTO COMMANDES (ID_CLIENT,DATE_COMMANDE,STATUT,MODE_PAIEMENT,MONTANT_TOTAL)"
                      "VALUES (:ID_CLIENT,:DATE_COMMANDE,:STATUT,:MODE_PAIEMENT,:MONTANT_TOTAL)");
    ...
    bool commande::modifier()    {
        QSqlQuery query;
        query.prepare("UPDATE  COMMANDES SET ID_CLIENT=:ID_CLIENT,DATE_COMMANDE=:DATE_COMMANDE,STATUT=:STATUT,MODE_PAIEMENT=:MODE_PAIEMENT,MONTANT_TOTAL=:MONTANT_TOTAL"
