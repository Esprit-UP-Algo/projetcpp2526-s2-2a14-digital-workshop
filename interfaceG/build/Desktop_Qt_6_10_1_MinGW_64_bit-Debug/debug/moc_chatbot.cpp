...
void Chatbot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->erreurReseau((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Chatbot::*)(const QString & )>(_a, &Chatbot::reponseRecue, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Chatbot::*)(const QString & )>(_a, &Chatbot::erreurReseau, 1))
            return;
    }
}
...
// SIGNAL 0
void Chatbot::reponseRecue(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Chatbot::erreurReseau(const QString & _t1)
{
